...
def add_task(tasks):
    """
    Prompt the user for a task description, add it to `tasks`, and confirm.
    """
...
def view_tasks(tasks):
    """
    Display all tasks in `tasks`, numbered from 1.
...
def delete_task(tasks):
    """
    Show the tasks, ask which number to remove, and delete it.
