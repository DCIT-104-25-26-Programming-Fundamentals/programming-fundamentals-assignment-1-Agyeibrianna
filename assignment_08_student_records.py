...
def find_student(students, student_id):
    """
    Return the student dictionary matching `student_id`, or None if not found.
    """
...
def add_student(students):
    ...
    new student record to `students`.
    """
...
def display_all_students(students):
    """
    Print a formatted table of all student records, including their
    name, ID, scores, and average score.
    """
    if not students:
    ...
    for student in students:
        scores_str = ", ".join(f"{score:g}" for score in student["scores"])
...
def calculate_student_average(students):
    """
    Ask for a student ID, find the matching student, and display their
